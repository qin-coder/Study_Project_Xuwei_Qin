...
public class ClientProcess {
    ...
    public static void main(String[] args) {
        ...
        try {
                ...
                if (!onThread) {
                    ...
                    LoggingUtils.getEvoLogger().info("* end of systemexit");
                }
    ...
    public void run() {
        ...
        LoggingUtils.getEvoLogger().info("* end fo reg");
        ...
        LoggingUtils.getEvoLogger().info("* end fo logreg");
        ...
        LoggingUtils.getEvoLogger().info("* end fo spawn");
        ...
        LoggingUtils.getEvoLogger().info("* next loop");
...
//        LoggingUtils.getEvoLogger().info("* loadstopped");
//
//        registered = ClientServices.getInstance().registerServices(getIdentifier());
//        if (!registered) {
//            result = TestGenerationResultBuilder.buildErrorResult("Could not connect to master process on port "
//                    + Properties.PROCESS_COMMUNICATION_PORT);
//            throw new RuntimeException(getPrettyPrintIdentifier() + "Could not connect to master process on port "
...
//        }
        ...
        LoggingUtils.getEvoLogger().info("* end fo waitunitldone");
        ClientServices.getInstance().stopServices();
        LoggingUtils.getEvoLogger().info("* end fo stopservice");
        SpawnProcessKeepAliveChecker.getInstance().unRegister();
        LoggingUtils.getEvoLogger().info("* end fo unreg");
    }
