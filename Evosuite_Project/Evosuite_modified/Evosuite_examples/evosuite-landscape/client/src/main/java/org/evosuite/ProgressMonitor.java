...
//        LoggingUtils.getEvoLogger().info("* updatestatus started-----------");
//        use
...
//        LoggingUtils.getEvoLogger().info("* searchstarted started-----------");
...
//        LoggingUtils.getEvoLogger().info("* iteration started-----------");
//        use
...
//        LoggingUtils.getEvoLogger().info("* searchfinished started-----------");
...
//        LoggingUtils.getEvoLogger().info("* fitnesseva started-----------");
