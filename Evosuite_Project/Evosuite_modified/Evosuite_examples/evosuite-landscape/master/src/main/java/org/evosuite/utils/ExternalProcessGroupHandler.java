...
public class ExternalProcessGroupHandler {
    ...
    protected boolean startProcess(String[] command, int processIndex, Object population_data) {
        ...
        if (!Properties.CLIENT_ON_THREAD) {
            ...
            while(true){
//                failed to start
                logger.info("start from master:");
                logger.info(String.valueOf(Properties.RLNumEpisodes));
                LoggingUtils.getEvoLogger().info("* Starting ");
                LoggingUtils.getEvoLogger().info(String.valueOf(Properties.RLNumEpisodes));
                /*
