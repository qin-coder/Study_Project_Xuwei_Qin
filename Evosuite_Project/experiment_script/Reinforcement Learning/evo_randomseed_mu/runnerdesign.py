...
for episode in range(0, max_episode):
    ...
    with open('log.txt', 'a') as file:
        ...
        file.write(str(num_mutation_rate))
        file.write("\nPresent class:")
        file.write("com.ib.client.EWrapperMsgGenerator(Random seed After RL)")
        file.write("\n-------------------------------------------------------\n")

    previous_coverage = num_coverage
    previous_mutation_rate = num_mutation_rate

    os.system(f'java -jar evosuite_random_mu.jar -class com.ib.client.EWrapperMsgGenerator -projectCP ./')
