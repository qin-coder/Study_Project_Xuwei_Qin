        ...
        for class_file in class_files:
            ...
            class RLAgent:
                ...
                def run_episode(self, env, num_coverage, num_mutation_rate):
                    ...
                    next_state, num_coverage, num_mutation_rate, reward = env.step(action, num_coverage,
                                                                                   num_mutation_rate)
            ...
            for episode in range(1, max_episode):
                ...
                os.system(f'java -jar evosuite_fixedseed_mu.jar -class {class_name} -projectCP ' + classpath)
